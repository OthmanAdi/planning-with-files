...
استدعاء مهارة planning-with-files:planning-with-files وتنفيذ التعليمات بدقة.
...
ثم ارشد المستخدم خلال سير عمل التخطيط. جميع ملفات التخطيط وجميع ردودك يجب أن تكون باللغة العربية.
