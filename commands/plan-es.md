...
Invocar la habilidad planning-with-files:planning-with-files y ejecutar sus instrucciones estrictamente.
...
Luego guía al usuario a través del flujo de trabajo de planificación. Todos los archivos de planificación y todas tus respuestas deben estar en español.
